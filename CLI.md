...
This file provides guidance to any CLI tool when working with code in this repository.

## Repository Overview

This is Ralph for any CLI tool - an autonomous AI development loop system that enables continuous development cycles with intelligent exit detection and rate limiting.

**Version**: v0.0.1 | **Tests**: Comprehensive test suite | **CI/CD**: GitHub Actions
...
2. **lib/response_analyzer.sh** - Intelligent response analysis
   - Analyzes CLI tool output for completion signals
